...
public class Config {
	...
	public Integer getSuhoorMTAlert() {
		return params.getInteger(SUHOOR_MT_ALERT);
	}

	private Config setSuhoorMTAlert(Integer value) {
		params.put(SUHOOR_MT_ALERT, value);
		return this;
	}

	public Integer getSuhoorWDAlert() {
		return params.getInteger(SUHOOR_WD_ALERT);
	}
