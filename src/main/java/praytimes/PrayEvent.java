...
//		event.getProperties().add(new Location(cfg.getLocation()));
	...
	public static String getMinutesToTime(long totalMinutes) {
        ...
        public LocalDateTime getAdjustedLocalDateTime() {
            return startTime.toLocalDateTime().minusMinutes(cfg.getTZDSTOffset());
        }

        public HijrahDate getHijrahDate() {
            return HijrahDate.from(getAdjustedLocalDateTime().toLocalDate());
        }
        ...
        public boolean isMondayOrThursday() {
            DayOfWeek dow = getStartTime()
                               .toLocalDateTime()
                               .minusMinutes(cfg.getTZDSTOffset()) // как в toEvent()
                               .getDayOfWeek();
