...
<body>
    <main role="main" class="container">
		...
		<div class="pl-3 pr-3">
			...
			<div class="pl-4 row">
				<label class="pr-2">
				  Suhoor alert on Monday/Thursday
				</label>
				<div class="ml-auto">
					<label class="toggle-switch-off">Off</label>
					<input name="csumt" type="range" class="custom-range toggle-switch" min="0" max="1" step="1" value="<%=cfg.getSuhoorMTAlert()%>">
					<label class="toggle-switch-on">On</label>
				</div>
			</div>
			<div class="pl-4 row">
				<label class="pr-2">
				  Suhoor alert on White Days
				</label>
				<div class="ml-auto">
					<label class="toggle-switch-off">Off</label>
